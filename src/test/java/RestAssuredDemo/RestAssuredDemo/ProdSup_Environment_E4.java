...
public class ProdSup_Environment_E4 extends BaseClass {
    ...
    @Test
    public static void ProdSup_Environment_E4() {
        ...
        try {
            ...
            String failureMessage = "ProdSup environment on E4 is down";
        ...
        String sucessMessage = "ProdSup environment on E4 is up and working fine";
