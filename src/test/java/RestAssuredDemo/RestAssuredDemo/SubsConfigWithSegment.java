...
public class SubsConfigWithSegment {
public static String subsConfigResoureURL;
	public static void SubsConfigWithSegment(String baseURL, String subscription) {
		...
		VSTSFileUploader.addResponseContentToUploadableFile(response, MVA10APIS.SUBS_CONFIG_WITH_SEGMENT.getName());
