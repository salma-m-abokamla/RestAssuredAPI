...
public class SIT1_Environment_E4 extends BaseClass {
    ...
    @Test
    public static void SIT1_Environment_E4() {
        baseURL = ConfigFileReader.getSIT1BaseUrl();
        ...
        try {
            ...
            String failureMessage = "SIT1 environment on E4 is down";
        ...
        String sucessMessage = "SIT1 environment on E4 is up and working fine";
