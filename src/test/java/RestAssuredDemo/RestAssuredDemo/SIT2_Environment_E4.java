...
public class SIT2_Environment_E4 extends BaseClass {
    ...
    @Test
    public static void SIT2_Environment_E4() {
        baseURL = ConfigFileReader.getSIT2BaseUrl();
        ...
        try {
            ...
            String failureMessage = "SIT2 environment on E4 is down";
        ...
        String sucessMessage = "SIT2 environment on E4 is up and working fine";
