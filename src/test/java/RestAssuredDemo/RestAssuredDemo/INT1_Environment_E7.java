...
public class INT1_Environment_E7 extends BaseClass {
    ...
    public static void INT1_Environment_E7() {
        ...
        try {
            ...
            String failureMessage = "INT1 environment on E7 is down";
        ...
        String sucessMessage = "INT1 environment on E7 is up and working fine";
