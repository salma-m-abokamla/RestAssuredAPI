...
public class UFLAPIs_Suite extends BaseClass {
	...
	@Parameters({ "baseURL", "registeredNumbersResoureURL", "subscription", "userName" })
	@Test(priority = 1)
	public void RegisteredNumbers(String baseURL, String registeredNumbersResoureURL, String subscription,
			String userName) {
