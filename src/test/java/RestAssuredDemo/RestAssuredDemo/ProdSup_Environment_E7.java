...
public class ProdSup_Environment_E7 extends BaseClass {
    ...
    @Test
    public static void ProdSup_Environment_E7() {
        ...
        try {
            ...
            String failureMessage = "ProdSup environment on E7 is down";
        ...
        String sucessMessage = "ProdSup environment on E7 is up and working fine";
