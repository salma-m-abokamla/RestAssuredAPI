...
public class ProdSup_Environment_SUP02 extends BaseClass {
    ...
    @Test
    public static void ProdSup_Environment_SUP02() {
        baseURL = ConfigFileReader.getProdSubBaseUrl();
        System.out.println("BaseUrl :" + baseURL);
        subscription = ConfigFileReader.readSUP02TestData();
        ...
        try {
            ...
            String failureMessage = "ProdSup environment on SUP02 is down";
        ...
        String sucessMessage = "ProdSup environment on SUP02 is up and working fine";
