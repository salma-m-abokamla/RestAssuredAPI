...
public class VSTSFileUploader {
    ...
    //TODO add the new repo url which will host all the responses files
    private static final String REMOTE_URL = "https://vfuk-digital.visualstudio.com/Digital/_git/jGit";

    // Username and password generated by the VSTS Repo
    //TODO generate new username and password from the url of the above repo
    private static final String USERNAME = "karim.ismaiel";
    private static final String PASSWORD = "rjkbqjvflk3bkzs77ybrltg2owjkkq2dkfvksynzt2iek3glkqsa";
